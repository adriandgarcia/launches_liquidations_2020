...
Data filtered to remove rows where the share class was launched and liquidated during the same calendar year.
48,517 rows, 39 columns
...
The results for 2020 ended up equal after acounting for the five funds that appear to have launched and been liquidated within 2020. This method considers those funds obsolete.
